...
$("#pengunduran-diri-table").DataTable({
  scrollX: true,
});

$("#pindah-cabang-table").DataTable({
  scrollX: true,
});
$("#klaim-iuran-table").DataTable({
  scrollX: true,
});
$("#realisasi-table").DataTable({
  scrollX: true,
});
$("#peningkatan-table").DataTable({
  scrollX: true,
});
$("#legalisir-table").DataTable({
  scrollX: true,
});
$("#perpanjangan-kta-table").DataTable({
  scrollX: true,
});
